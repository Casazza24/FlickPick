...
The team will use an **Agile hybrid methodology** combining Scrum and Kanban practices:

- **Weekly Scrum stand-ups** at the start of each meeting to share progress, blockers, and goals
- **GitHub Projects Kanban board** to track tasks across four columns: *Backlog*, *In Progress*, *In Review*, and *Done*
- **GitHub Issues** used for individual user stories and bug tracking, referenced in all commits and PRs
- **Feature branches + pull requests** for all new code; at least one peer review required before merging to `main`
- Work will be organized into **one-week sprints** aligned with lab deadlines
...
| Layer | Technology |
|-------|-----------|
| Frontend | Handlebars (HBS) templates, CSS, vanilla JS |
| Backend | Node.js + Express |
| Database | PostgreSQL 14 |
| Movie Data API | [FILL IN — e.g., The Movie Database (TMDb)] |
